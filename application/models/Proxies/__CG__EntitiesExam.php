 ...
 */
class Exam extends \Entities\Exam implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'remarks', 'date_created', 'date_last_modified', 'is_valid', 'term', 'exam_status');
    }
