 ...
 */
class Bursary extends \Entities\Bursary implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setGivenBy($givenBy);
    }

    public function getGivenBy()
    {
        $this->__load();
        return parent::getGivenBy();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'amount', 'comments', 'given_by', 'date_created', 'date_last_modified', 'is_valid', 'student', 'term', 'transaction');
    }
