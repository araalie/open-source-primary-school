 ...
 */
class StudentRequiredItem extends \Entities\StudentRequiredItem implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'description', 'date_created', 'date_last_modified', 'is_valid', 'fees_profile');
    }
