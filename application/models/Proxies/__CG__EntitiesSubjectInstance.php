 ...
 */
class SubjectInstance extends \Entities\SubjectInstance implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setSubjectInstanceStatus($subjectInstanceStatus);
    }

    public function getSubjectInstanceStatus()
    {
        $this->__load();
        return parent::getSubjectInstanceStatus();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'date_created', 'date_last_modified', 'is_valid', 'subject_instance_status', 'study_subject', 'class_instance', 'teacher');
    }
