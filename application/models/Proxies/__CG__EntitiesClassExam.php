 ...
 */
class ClassExam extends \Entities\ClassExam implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setExamStatus($examStatus);
    }

    public function getExamStatus()
    {
        $this->__load();
        return parent::getExamStatus();
    }

    public function setGradingMode(\Entities\GradingMode $gradingMode = NULL)
    {
        $this->__load();
        return parent::setGradingMode($gradingMode);
    }

    public function getGradingMode()
    {
        $this->__load();
        return parent::getGradingMode();
    }


    public function __sleep()
    {
        return array('__isInitialized__', 'id', 'date_created', 'date_last_modified', 'is_valid', 'exam', 'class_instance', 'exam_status', 'grading_mode');
    }
