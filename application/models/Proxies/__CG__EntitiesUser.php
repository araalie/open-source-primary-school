...
class User extends \Entities\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'username', 'email', 'password', 'activated', 'banned', 'ban_reason', 'new_password_key', 'new_password_requested', 'new_email', 'new_email_key', 'last_ip', 'last_login', 'created', 'modified', 'is_valid');
    }
