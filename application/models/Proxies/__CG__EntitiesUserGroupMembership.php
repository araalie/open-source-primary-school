 ...
 */
class UserGroupMembership extends \Entities\UserGroupMembership implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setSchoolStaff($schoolStaff);
    }

    public function getSchoolStaff()
    {
        $this->__load();
        return parent::getSchoolStaff();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'date_created', 'date_last_modified', 'is_valid', 'school_staff', 'user_group');
    }
