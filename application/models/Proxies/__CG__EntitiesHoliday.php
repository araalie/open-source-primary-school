 ...
 */
class Holiday extends \Entities\Holiday implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'description', 'date_began', 'date_ended', 'date_created', 'date_last_modified', 'is_valid', 'term');
    }
