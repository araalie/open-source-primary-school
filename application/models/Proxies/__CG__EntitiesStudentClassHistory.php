 ...
 */
class StudentClassHistory extends \Entities\StudentClassHistory implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'comment', 'date_created', 'date_last_modified', 'is_valid', 'class_instance', 'student', 'term', 'fees_profile');
    }
