 ...
 */
class SubjectExamGrading extends \Entities\SubjectExamGrading implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'date_created', 'date_last_modified', 'is_valid', 'grading', 'subject_instance', 'exam');
    }
